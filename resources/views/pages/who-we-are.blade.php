            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-lg-6 col-md-9 col-sm-10">
                    <div class="about__img-wrap-four">
                        ...
                        <div class="shape">
                            <img src="assets/img/images/inner_about_shape.jpg" alt="Apexa" class="alltuchtopdown" />
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
            ...
            <div class="row justify-content-center">
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-8">
                    <div class="team__item-four shine-animate-item">
                        ...
                        <div class="team__content-four">
                            <h2 class="title"><a href="team-details">Floyd Miles</a></h2>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-8">
                    <div class="team__item-four shine-animate-item">
                        ...
                        <div class="team__content-four">
                            <h2 class="title"><a href="team-details">Ralph Edwards</a></h2>
                            <span>Finance Advisor</span>
                            <div class="team__social-four">
                                <ul class="list-wrap">
                                    <li>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-8">
                    <div class="team__item-four shine-animate-item">
                        ...
                        <div class="team__content-four">
                            <h2 class="title"><a href="team-details">Eleanor Pena</a></h2>
                            <span>Finance Advisor</span>
                            <div class="team__social-four">
                                <ul class="list-wrap">
                                    <li>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-8">
                    <div class="team__item-four shine-animate-item">
                        ...
                        <div class="team__content-four">
                            <h2 class="title"><a href="team-details">Jone Cooper</a></h2>
                            <span>Finance Advisor</span>
                            <div class="team__social-four">
                                <ul class="list-wrap">
                                    <li>
