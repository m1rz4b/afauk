...
<main class="fix">
                    ...
                    <div class="about-content">
                        <div class="section-title mb-35 tg-heading-subheading animation-style3">
                            ...
                            <h2 class="title tg-element-title">
                                ...
                                Make Ultimate Businesses Growth Success.
                            </h2>
                        </div>
                        ...
                        <div class="about-bottom">
                            <div class="author-wrap">
                                <div class="thumb">
                                    <img src="assets/img/images/author_img.png" alt="Apexa" />
                                </div>
                                <div class="content">
            ...
            <div class="row justify-content-center">
                <div class="col-xl-6 col-lg-8">
                    <div class="section-title text-center mb-40 tg-heading-subheading animation-style3">
                        ...
                        <h2 class="title tg-element-title">We Offer An Effective Wide Area Business solutions</h2>
                    </div>
                </div>
            </div>
            <div class="services-item-wrap">
                <div class="row justify-content-center">
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-8">
                        <div class="services-item shine-animate-item">
                            <div class="services-thumb">
                                <a href="services-details" class="shine-animate"><img src="assets/img/services/services_img01.jpg" alt="Apexa" /></a>
                            </div>
                            <div class="services-content">
                                ...
                                <a href="services-details" class="btn">Read More</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-8">
                        <div class="services-item shine-animate-item">
                            <div class="services-thumb">
                                <a href="services-details" class="shine-animate"><img src="assets/img/services/services_img02.jpg" alt="Apexa" /></a>
                            </div>
                            <div class="services-content">
                                <div class="icon">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-8">
                        <div class="services-item shine-animate-item">
                            <div class="services-thumb">
                                <a href="services-details" class="shine-animate"><img src="assets/img/services/services_img03.jpg" alt="Apexa" /></a>
                            </div>
                            <div class="services-content">
                                <div class="icon">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-8">
                        <div class="services-item shine-animate-item">
                            <div class="services-thumb">
                                <a href="services-details" class="shine-animate"><img src="assets/img/services/services_img04.jpg" alt="Apexa" /></a>
                            </div>
                            <div class="services-content">
                                <div class="icon">
                                    <i class="flaticon-light-bulb"></i>
                                </div>
                                <h4 class="title"><a href="services-details">Business consulting</a></h4>
                                <p>Morem ipsum dolor sittemet consectetur adipiscing.</p>
                                <a href="services-details" class="btn">Read More</a>
                            </div>
                        </div>
            ...
            <div class="container custom-container-two">
                <div class="row">
                    <div class="col-xl-3 col-md-6">
                        <div class="project-item">
                            <div class="project-thumb">
                                <a href="project-details"><img src="assets/img/project/project_img01.jpg" alt="Apexa" /></a>
                            </div>
                    ...
                    <div class="col-xl-3 col-md-6">
                        <div class="project-item">
                            <div class="project-thumb">
                                <a href="project-details"><img src="assets/img/project/project_img02.jpg" alt="Apexa" /></a>
                            </div>
                            <div class="project-content">
                                <div class="left-side-content">
                    ...
                    <div class="col-xl-3 col-md-6">
                        <div class="project-item">
                            <div class="project-thumb">
                                <a href="project-details"><img src="assets/img/project/project_img03.jpg" alt="Apexa" /></a>
                            </div>
                            <div class="project-content">
                                <div class="left-side-content">
                                    <h4 class="title"><a href="project-details">Inventory Management</a></h4>
                    ...
                    <div class="col-xl-3 col-md-6">
                        <div class="project-item">
                            <div class="project-thumb">
                                <a href="project-details"><img src="assets/img/project/project_img04.jpg" alt="Apexa" /></a>
                            </div>
                            <div class="project-content">
                                <div class="left-side-content">
                                    <h4 class="title"><a href="project-details">Business Accounting</a></h4>
    ...
    <section class="testimonial-area">
        ...
        <div class="testimonial-shape-wrap">
            ...
            <img src="assets/img/images/testimonial_shape06.png" alt="Apexa" data-aos="fade-left" data-aos-delay="400" />
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-xl-4 col-lg-6 col-md-10">
                    <div class="blog-post-item shine-animate-item">
                        <div class="blog-post-thumb">
                            <a href="blog-details" class="shine-animate"><img src="assets/img/blog/blog_post01.jpg" alt="Apexa" /></a>
                ...
                <div class="col-xl-4 col-lg-6 col-md-10">
                    <div class="blog-post-item shine-animate-item">
                        <div class="blog-post-thumb">
                            <a href="blog-details" class="shine-animate"><img src="assets/img/blog/blog_post02.jpg" alt="Apexa" /></a>
                ...
                <div class="col-xl-4 col-lg-6 col-md-10">
                    <div class="blog-post-item shine-animate-item">
                        <div class="blog-post-thumb">
                            <a href="blog-details" class="shine-animate"><img src="assets/img/blog/blog_post03.jpg" alt="Apexa" /></a>
